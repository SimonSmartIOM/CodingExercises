...
for (int i = 0; i < numberOfStages; i++) {
    ...
    availableStages.Add(new(emptyMass: emptyMass, fuelMass: fuelMass, thrust: thrust, fuelConsumption: fuelConsumption));
}
...
Console.WriteLine(Math.Round(idealRocketCalculator.MaximumAchievableSpeed));