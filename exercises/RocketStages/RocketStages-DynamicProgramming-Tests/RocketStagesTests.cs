...
namespace RocketStages_DynamicProgramming_Tests;

/// <summary>
/// Tests for the Dynamic Programming solution to the Rocket Stages problem.
/// </summary>
public class Tests {
    ...
    public void RocketStagesTests(List<Stage> availableStages, int expectedMaximumSpeed) {
        ...
        // ACT
        int actualMaximumAchievableSpeed = (int)Math.Round(idealRocketCalculator.MaximumPossibleSpeed);
