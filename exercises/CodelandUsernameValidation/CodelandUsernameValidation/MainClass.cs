...
public class PasswordValidator {
    ...
    [MustOnlyContainLettersNumbersAndUnderscores(ErrorMessage = "Password may only contain letters, numbers and underscores.")]
    ...
    /// </summary>
    public readonly List<ValidationResult> ValidationResults = new();
